...
const Sidebar = () => {
  ...
  if (role === "superadmin") {
    routes.push(
      ...
      {
        key: "/teleconsult_delivery",
        label: "Telemed Delivery",
        icon: <DeliveredProcedureOutlined />,
      },
      {
        key: "appointments_mgmt",
        ...
        children: [
          ...
          {
            key: "/appointments/onsite-branches",
            label: "Onsite Branches",
            icon: <EnvironmentOutlined />,
          },
          {
            key: "/appointments/onsite-hours",
            label: "Operating Hours",
            icon: <CalendarOutlined />,
          },
          {
            key: "/appointments/corporate-codes",
            label: "Corporate Codes & Quotas",
            icon: <BarChartOutlined />,
          },
        ],
      },
      {
        ...
        children: [
          {
            key: "/teleconsults/ongoing",
            label: "Ongoing Teleconsults",
            icon: <SyncOutlined />,
          },
          {
            key: "/documents/hidden",
            label: "Hidden Documents",
            icon: <FileUnknownOutlined />,
          },
          // { key: '/rates', label: 'Dynamic Rates (Legacy)', icon: <DollarOutlined />},
          {
            key: "/rates/dynamic",
            label: "Configure Dynamic Rates",
            icon: <DollarOutlined />,
          },
          ...
          {
            key: "/corporate/upload",
            label: "Upload Corporate Users",
            icon: <UsergroupAddOutlined />,
          },
        ],
      },
      ...
      },
      {
        ...
        children: [
          ...
          {
            key: "/reports/health-reports",
            label: "Health Reports",
            icon: <FileTextOutlined />,
          },
          {
            key: "/reports/export-health-reports",
            label: "Export Health Reports",
      ...
      },
      {
        ...
        children: [
          {
            key: "/specialist-care/specialisations",
          ...
          {
            key: "/specialist-care/email-template",
  ...
  routes.push({ key: "/logout", label: "Logout", icon: <LogoutOutlined /> });
          ...
          <div className="flex-1">
            <div className="flex items-center p-4">
              <img
                ...
                src={PinnacleLogo}
                alt="Pinnacle Clinic Logo"
              />
              <h1 className="font-semibold text-md p-2 text-white">
                Pinnacle Clinic
              </h1>
            </div>
            <Menu
