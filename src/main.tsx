...
import PaymentAuthorizationManagement from "./pages/payments/authorization-management";
    ...
    <Routes>
      <Route element={<AuthRoute />}>
        ...
        <Route path="/appointments" element={<ScreenLayout />}>
          ...
          <Route path="controls" element={<AppointmentControlsScreen />} />
          <Route path="services" element={<AppointmentServices />} />
          <Route path="services/:groupId" element={<ServiceDetails />} />
          <Route
            path="corporate-codes"
            element={<AppointmentCorporateCodes />}
          />
          <Route path="onsite-hours" element={<OnsiteHours />} />
          <Route path="onsite-branches" element={<OnsiteBranches />} />
          <Route
            path="onsite-branches/:branchId"
            element={<OnsiteBranchDetails />}
          />
        </Route>
        <Route path="/payments" element={<ScreenLayout />}>
          <Route
            path="authorizations"
            element={<PaymentAuthorizationManagement />}
          />
        </Route>
        ...
        <Route path="/branches" element={<ScreenLayout />}>
          ...
          <Route
            path=":branchId/operating-hours"
            element={<BranchOperatingHours />}
          />
          <Route
            path=":branchId/appointment-hours"
            element={<BranchAppointmentHours />}
          />
        </Route>
        <Route path="/dates" element={<ScreenLayout />}>
          ...
          <Route
            path="public_holidays/create"
            element={<PublicHolidayUpsertScreen />}
          />
          <Route
